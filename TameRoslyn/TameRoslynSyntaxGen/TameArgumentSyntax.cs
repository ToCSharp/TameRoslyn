...
{
    public partial class TameArgumentSyntax : TameBaseRoslynNode
    {
        public static string TypeName = "ArgumentSyntax";
        ...
        public TameArgumentSyntax(string code)
        {
            Node = SyntaxFactoryStr.ParseArgument(code);
            AddChildren();
        }

        public TameArgumentSyntax(ArgumentSyntax node)
        {
            Node = node;
            AddChildren();
        }

        public TameArgumentSyntax()
        {
            NameColonStr = DefaultValues.ArgumentSyntaxNameColonStr;
            RefOrOutKeywordStr = DefaultValues.ArgumentSyntaxRefOrOutKeywordStr;
            ExpressionStr = DefaultValues.ArgumentSyntaxExpressionStr;
        }
        ...
        {
            var res = SyntaxFactory.Argument(NameColon, RefOrOutKeyword, Expression);
            IsChanged = false;
            return res;
        }
