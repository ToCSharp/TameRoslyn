...
{
    public partial class TameCastExpressionSyntax : TameExpressionSyntax
    {
        public new static string TypeName = "CastExpressionSyntax";
        ...
        public TameCastExpressionSyntax(string code)
        {
            Node = SyntaxFactoryStr.ParseCastExpression(code);
            AddChildren();
        }

        public TameCastExpressionSyntax(CastExpressionSyntax node)
        {
            Node = node;
            AddChildren();
        }

        public TameCastExpressionSyntax()
        {
            OpenParenTokenStr = DefaultValues.CastExpressionSyntaxOpenParenTokenStr;
            TypeStr = DefaultValues.CastExpressionSyntaxTypeStr;
            CloseParenTokenStr = DefaultValues.CastExpressionSyntaxCloseParenTokenStr;
            ExpressionStr = DefaultValues.CastExpressionSyntaxExpressionStr;
        }
        ...
        public new void AddChildren()
        {
            base.AddChildren();
            Kind = Node.Kind();
            _openParenToken = ((CastExpressionSyntax) Node).OpenParenToken;
            _openParenTokenIsChanged = false;
            _type = ((CastExpressionSyntax) Node).Type;
            _typeIsChanged = false;
            _closeParenToken = ((CastExpressionSyntax) Node).CloseParenToken;
            _closeParenTokenIsChanged = false;
            _expression = ((CastExpressionSyntax) Node).Expression;
            _expressionIsChanged = false;
        }
        ...
        {
            var res = SyntaxFactory.CastExpression(OpenParenToken, Type, CloseParenToken, Expression);
            IsChanged = false;
            return res;
        }
