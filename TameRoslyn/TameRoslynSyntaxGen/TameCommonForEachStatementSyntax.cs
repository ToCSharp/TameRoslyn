...
{
    public class TameCommonForEachStatementSyntax : TameStatementSyntax
    {
        public new static string TypeName = "CommonForEachStatementSyntax";
        ...
        private SyntaxToken _forEachKeyword;
        private bool _forEachKeywordIsChanged;
        private string _forEachKeywordStr;
        ...
        public TameCommonForEachStatementSyntax(string code)
        {
            Node = SyntaxFactoryStr.ParseCommonForEachStatement(code);
            AddChildren();
        }
        ...
        public TameCommonForEachStatementSyntax()
        {
        }
        ...
        public SyntaxToken ForEachKeyword
        {
            get
            {
                if (_forEachKeywordIsChanged)
                {
                    if (_forEachKeywordStr == null) _forEachKeyword = default(SyntaxToken);
                    else
                        _forEachKeyword =
                            SyntaxFactoryStr.ParseSyntaxToken(_forEachKeywordStr, SyntaxKind.ForEachKeyword);
                    _forEachKeywordIsChanged = false;
                }
                return _forEachKeyword;
            }
            set
            {
                if (_forEachKeyword != value)
                {
                    _forEachKeyword = value;
                    _forEachKeywordIsChanged = false;
                    IsChanged = true;
                }
            }
        ...
        public string ForEachKeywordStr
        {
            get
            {
                if (_forEachKeywordIsChanged) return _forEachKeywordStr;
                return _forEachKeywordStr = _forEachKeyword.Text;
            }
            set
            {
                if (_forEachKeywordStr != value)
                {
                    _forEachKeywordStr = value;
                    IsChanged = true;
                    _forEachKeywordIsChanged = true;
                }
            }
        }
        ...
        public new void AddChildren()
        {
            base.AddChildren();
            Kind = Node.Kind();
            _forEachKeyword = ((CommonForEachStatementSyntax) Node).ForEachKeyword;
            _forEachKeywordIsChanged = false;
            _openParenToken = ((CommonForEachStatementSyntax) Node).OpenParenToken;
            _openParenTokenIsChanged = false;
            _inKeyword = ((CommonForEachStatementSyntax) Node).InKeyword;
            _inKeywordIsChanged = false;
            _expression = ((CommonForEachStatementSyntax) Node).Expression;
            _expressionIsChanged = false;
            _closeParenToken = ((CommonForEachStatementSyntax) Node).CloseParenToken;
            _closeParenTokenIsChanged = false;
            _statement = ((CommonForEachStatementSyntax) Node).Statement;
            _statementIsChanged = false;
        }
