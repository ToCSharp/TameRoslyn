...
{
    public partial class TameImplicitElementAccessSyntax : TameExpressionSyntax
    {
        public new static string TypeName = "ImplicitElementAccessSyntax";
        ...
        public TameImplicitElementAccessSyntax(string code)
        {
            Node = SyntaxFactoryStr.ParseImplicitElementAccess(code);
            AddChildren();
        }
        ...
        public TameImplicitElementAccessSyntax()
        {
            ArgumentListStr = DefaultValues.ImplicitElementAccessSyntaxArgumentListStr;
        }
        ...
        {
            var res = SyntaxFactory.ImplicitElementAccess(ArgumentList);
            IsChanged = false;
            return res;
        }
