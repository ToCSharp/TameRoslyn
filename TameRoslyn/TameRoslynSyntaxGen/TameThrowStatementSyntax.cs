...
{
    public partial class TameThrowStatementSyntax : TameStatementSyntax
    {
        public new static string TypeName = "ThrowStatementSyntax";
        ...
        public TameThrowStatementSyntax(string code)
        {
            Node = SyntaxFactoryStr.ParseThrowStatement(code);
            AddChildren();
        }

        public TameThrowStatementSyntax(ThrowStatementSyntax node)
        {
            Node = node;
            AddChildren();
        }

        public TameThrowStatementSyntax()
        {
            ThrowKeywordStr = DefaultValues.ThrowStatementSyntaxThrowKeywordStr;
            ExpressionStr = DefaultValues.ThrowStatementSyntaxExpressionStr;
            SemicolonTokenStr = DefaultValues.ThrowStatementSyntaxSemicolonTokenStr;
        }
        ...
        public new void AddChildren()
        {
            base.AddChildren();
            Kind = Node.Kind();
            _throwKeyword = ((ThrowStatementSyntax) Node).ThrowKeyword;
            _throwKeywordIsChanged = false;
            _expression = ((ThrowStatementSyntax) Node).Expression;
            _expressionIsChanged = false;
            _semicolonToken = ((ThrowStatementSyntax) Node).SemicolonToken;
            _semicolonTokenIsChanged = false;
        }
        ...
        {
            var res = SyntaxFactory.ThrowStatement(ThrowKeyword, Expression, SemicolonToken);
            IsChanged = false;
            return res;
        }
