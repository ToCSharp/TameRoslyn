...
{
    public partial class TameTypeOfExpressionSyntax : TameExpressionSyntax
    {
        public new static string TypeName = "TypeOfExpressionSyntax";
        ...
        public TameTypeOfExpressionSyntax(string code)
        {
            Node = SyntaxFactoryStr.ParseTypeOfExpression(code);
            AddChildren();
        }

        public TameTypeOfExpressionSyntax(TypeOfExpressionSyntax node)
        {
            Node = node;
            AddChildren();
        }

        public TameTypeOfExpressionSyntax()
        {
            KeywordStr = DefaultValues.TypeOfExpressionSyntaxKeywordStr;
            OpenParenTokenStr = DefaultValues.TypeOfExpressionSyntaxOpenParenTokenStr;
            TypeStr = DefaultValues.TypeOfExpressionSyntaxTypeStr;
            CloseParenTokenStr = DefaultValues.TypeOfExpressionSyntaxCloseParenTokenStr;
        }
        ...
        public new void AddChildren()
        {
            base.AddChildren();
            Kind = Node.Kind();
            _keyword = ((TypeOfExpressionSyntax) Node).Keyword;
            _keywordIsChanged = false;
            _openParenToken = ((TypeOfExpressionSyntax) Node).OpenParenToken;
            _openParenTokenIsChanged = false;
            _type = ((TypeOfExpressionSyntax) Node).Type;
            _typeIsChanged = false;
            _closeParenToken = ((TypeOfExpressionSyntax) Node).CloseParenToken;
            _closeParenTokenIsChanged = false;
        }
        ...
        {
            var res = SyntaxFactory.TypeOfExpression(Keyword, OpenParenToken, Type, CloseParenToken);
            IsChanged = false;
            return res;
        }
