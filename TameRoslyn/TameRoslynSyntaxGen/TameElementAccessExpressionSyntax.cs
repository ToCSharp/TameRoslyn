...
{
    public partial class TameElementAccessExpressionSyntax : TameExpressionSyntax
    {
        public new static string TypeName = "ElementAccessExpressionSyntax";
        ...
        public TameElementAccessExpressionSyntax(string code)
        {
            Node = SyntaxFactoryStr.ParseElementAccessExpression(code);
            AddChildren();
        }

        public TameElementAccessExpressionSyntax(ElementAccessExpressionSyntax node)
        {
            Node = node;
            AddChildren();
        }

        public TameElementAccessExpressionSyntax()
        {
            ExpressionStr = DefaultValues.ElementAccessExpressionSyntaxExpressionStr;
            ArgumentListStr = DefaultValues.ElementAccessExpressionSyntaxArgumentListStr;
        }
        ...
        public new void AddChildren()
        {
            base.AddChildren();
            Kind = Node.Kind();
            _expression = ((ElementAccessExpressionSyntax) Node).Expression;
            _expressionIsChanged = false;
            _argumentList = ((ElementAccessExpressionSyntax) Node).ArgumentList;
            _argumentListIsChanged = false;
        }
        ...
        {
            var res = SyntaxFactory.ElementAccessExpression(Expression, ArgumentList);
            IsChanged = false;
            return res;
        }
