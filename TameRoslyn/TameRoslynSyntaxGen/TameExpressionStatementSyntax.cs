...
{
    public partial class TameExpressionStatementSyntax : TameStatementSyntax
    {
        public new static string TypeName = "ExpressionStatementSyntax";
        private bool _allowsAnyExpression;
        private bool _allowsAnyExpressionIsChanged;
        ...
        public TameExpressionStatementSyntax(string code)
        {
            Node = SyntaxFactoryStr.ParseExpressionStatement(code);
            AddChildren();
        }

        public TameExpressionStatementSyntax(ExpressionStatementSyntax node)
        {
            Node = node;
            AddChildren();
        }

        public TameExpressionStatementSyntax()
        {
            AllowsAnyExpression = DefaultValues.ExpressionStatementSyntaxAllowsAnyExpression;
            ExpressionStr = DefaultValues.ExpressionStatementSyntaxExpressionStr;
            SemicolonTokenStr = DefaultValues.ExpressionStatementSyntaxSemicolonTokenStr;
        }
        ...
        {
            get { return _allowsAnyExpression; }
            set
            {
                if (_allowsAnyExpression != value)
                {
                    _allowsAnyExpression = value;
                    _allowsAnyExpressionIsChanged = false;
                    IsChanged = true;
                }
            }
        }
        ...
        public new void AddChildren()
        {
            base.AddChildren();
            Kind = Node.Kind();
            _allowsAnyExpression = ((ExpressionStatementSyntax) Node).AllowsAnyExpression;
            _allowsAnyExpressionIsChanged = false;
            _expression = ((ExpressionStatementSyntax) Node).Expression;
            _expressionIsChanged = false;
            _semicolonToken = ((ExpressionStatementSyntax) Node).SemicolonToken;
            _semicolonTokenIsChanged = false;
        }
        ...
        {
            var res = SyntaxFactory.ExpressionStatement(Expression, SemicolonToken);
// if (AllowsAnyExpression != null) res = res.WithAllowsAnyExpression(AllowsAnyExpression);
            IsChanged = false;
            return res;
        }
        ...
        {
            yield return ("AllowsAnyExpression", AllowsAnyExpression.ToString());
