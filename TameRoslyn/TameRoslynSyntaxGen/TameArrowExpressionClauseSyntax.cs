...
{
    public partial class TameArrowExpressionClauseSyntax : TameBaseRoslynNode
    {
        public static string TypeName = "ArrowExpressionClauseSyntax";
        ...
        public TameArrowExpressionClauseSyntax(string code)
        {
            Node = SyntaxFactoryStr.ParseArrowExpressionClause(code);
            AddChildren();
        }

        public TameArrowExpressionClauseSyntax(ArrowExpressionClauseSyntax node)
        {
            Node = node;
            AddChildren();
        }

        public TameArrowExpressionClauseSyntax()
        {
            ArrowTokenStr = DefaultValues.ArrowExpressionClauseSyntaxArrowTokenStr;
            ExpressionStr = DefaultValues.ArrowExpressionClauseSyntaxExpressionStr;
        }
        ...
        {
            Kind = Node.Kind();
            _arrowToken = ((ArrowExpressionClauseSyntax) Node).ArrowToken;
            _arrowTokenIsChanged = false;
            _expression = ((ArrowExpressionClauseSyntax) Node).Expression;
            _expressionIsChanged = false;
        }
        ...
        {
            var res = SyntaxFactory.ArrowExpressionClause(ArrowToken, Expression);
            IsChanged = false;
            return res;
        }
