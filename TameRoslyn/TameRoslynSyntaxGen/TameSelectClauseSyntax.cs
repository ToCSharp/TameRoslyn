...
{
    public partial class TameSelectClauseSyntax : TameSelectOrGroupClauseSyntax
    {
        public new static string TypeName = "SelectClauseSyntax";
        private ExpressionSyntax _expression;
        private bool _expressionIsChanged;
        private string _expressionStr;
        private SyntaxToken _selectKeyword;
        private bool _selectKeywordIsChanged;
        private string _selectKeywordStr;
        private TameExpressionSyntax _taExpression;

        public TameSelectClauseSyntax(string code)
        {
            Node = SyntaxFactoryStr.ParseSelectClause(code);
            AddChildren();
        }
        ...
        public TameSelectClauseSyntax()
        {
            SelectKeywordStr = DefaultValues.SelectClauseSyntaxSelectKeywordStr;
            ExpressionStr = DefaultValues.SelectClauseSyntaxExpressionStr;
        }
        ...
        public SyntaxToken SelectKeyword
        {
            get
            {
                if (_selectKeywordIsChanged)
                {
                    if (_selectKeywordStr == null) _selectKeyword = default(SyntaxToken);
                    else
                        _selectKeyword = SyntaxFactoryStr.ParseSyntaxToken(_selectKeywordStr, SyntaxKind.SelectKeyword);
                    _selectKeywordIsChanged = false;
                }
                return _selectKeyword;
            }
            set
            {
                if (_selectKeyword != value)
                {
                    _selectKeyword = value;
                    _selectKeywordIsChanged = false;
                    IsChanged = true;
                }
            }
        ...
        public string SelectKeywordStr
        {
            get
            {
                if (_selectKeywordIsChanged) return _selectKeywordStr;
                return _selectKeywordStr = _selectKeyword.Text;
            }
            set
            {
                if (_selectKeywordStr != value)
                {
                    _selectKeywordStr = value;
                    IsChanged = true;
                    _selectKeywordIsChanged = true;
                }
            }
        }
        ...
        public new void AddChildren()
        {
            base.AddChildren();
            Kind = Node.Kind();
            _selectKeyword = ((SelectClauseSyntax) Node).SelectKeyword;
            _selectKeywordIsChanged = false;
            _expression = ((SelectClauseSyntax) Node).Expression;
            _expressionIsChanged = false;
        }
        ...
        {
            var res = SyntaxFactory.SelectClause(SelectKeyword, Expression);
            IsChanged = false;
            return res;
        }
        ...
        {
            yield return ("SelectKeywordStr", SelectKeywordStr);
