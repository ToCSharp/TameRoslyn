...
{
    public partial class TameCrefParameterSyntax : TameBaseRoslynNode
    {
        public static string TypeName = "CrefParameterSyntax";
        private SyntaxToken _refOrOutKeyword;
        private bool _refOrOutKeywordIsChanged;
        private string _refOrOutKeywordStr;
        private TameTypeSyntax _taType;
        private TypeSyntax _type;
        private bool _typeIsChanged;
        private string _typeStr;

        public TameCrefParameterSyntax(string code)
        {
            Node = SyntaxFactoryStr.ParseCrefParameter(code);
            AddChildren();
        }

        public TameCrefParameterSyntax(CrefParameterSyntax node)
        {
            Node = node;
            AddChildren();
        }

        public TameCrefParameterSyntax()
        {
            // RefOrOutKeywordStr = DefaultValues.CrefParameterSyntaxRefOrOutKeywordStr;
            // TypeStr = DefaultValues.CrefParameterSyntaxTypeStr;
        }
        ...
        public SyntaxToken RefOrOutKeyword
        {
            get
            {
                if (_refOrOutKeywordIsChanged)
                {
                    _refOrOutKeyword = SyntaxFactoryStr.ParseSyntaxToken(RefOrOutKeywordStr);
                    _refOrOutKeywordIsChanged = false;
                }
                return _refOrOutKeyword;
            }
            set
            {
                if (_refOrOutKeyword != value)
                {
                    _refOrOutKeyword = value;
                    _refOrOutKeywordIsChanged = false;
                    IsChanged = true;
                }
            }
        ...
        public string RefOrOutKeywordStr
        {
            get
            {
                if (_refOrOutKeywordIsChanged) return _refOrOutKeywordStr;
                return _refOrOutKeywordStr = _refOrOutKeyword.Text;
            }
            set
            {
                if (_refOrOutKeywordStr != value)
                {
                    _refOrOutKeywordStr = value;
                    IsChanged = true;
                    _refOrOutKeywordIsChanged = true;
                }
            }
        }
        ...
        {
            Kind = Node.Kind();
            _refOrOutKeyword = ((CrefParameterSyntax) Node).RefOrOutKeyword;
            _refOrOutKeywordIsChanged = false;
            _type = ((CrefParameterSyntax) Node).Type;
            _typeIsChanged = false;
        }
        ...
        {
            var res = SyntaxFactory.CrefParameter(RefOrOutKeyword, Type);
            IsChanged = false;
            return res;
        }
        ...
        {
            yield return ("RefOrOutKeywordStr", RefOrOutKeywordStr);
