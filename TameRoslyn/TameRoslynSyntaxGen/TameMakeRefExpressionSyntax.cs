...
{
    public partial class TameMakeRefExpressionSyntax : TameExpressionSyntax
    {
        public new static string TypeName = "MakeRefExpressionSyntax";
        ...
        public TameMakeRefExpressionSyntax(string code)
        {
            Node = SyntaxFactoryStr.ParseMakeRefExpression(code);
            AddChildren();
        }

        public TameMakeRefExpressionSyntax(MakeRefExpressionSyntax node)
        {
            Node = node;
            AddChildren();
        }

        public TameMakeRefExpressionSyntax()
        {
            // KeywordStr = DefaultValues.MakeRefExpressionSyntaxKeywordStr;
            // OpenParenTokenStr = DefaultValues.MakeRefExpressionSyntaxOpenParenTokenStr;
            // ExpressionStr = DefaultValues.MakeRefExpressionSyntaxExpressionStr;
            // CloseParenTokenStr = DefaultValues.MakeRefExpressionSyntaxCloseParenTokenStr;
        }
        ...
        public new void AddChildren()
        {
            base.AddChildren();
            Kind = Node.Kind();
            _keyword = ((MakeRefExpressionSyntax) Node).Keyword;
            _keywordIsChanged = false;
            _openParenToken = ((MakeRefExpressionSyntax) Node).OpenParenToken;
            _openParenTokenIsChanged = false;
            _expression = ((MakeRefExpressionSyntax) Node).Expression;
            _expressionIsChanged = false;
            _closeParenToken = ((MakeRefExpressionSyntax) Node).CloseParenToken;
            _closeParenTokenIsChanged = false;
        }
        ...
        {
            var res = SyntaxFactory.MakeRefExpression(Keyword, OpenParenToken, Expression, CloseParenToken);
            IsChanged = false;
            return res;
        }
