...
{
    public partial class TameCheckedExpressionSyntax : TameExpressionSyntax
    {
        public new static string TypeName = "CheckedExpressionSyntax";
        ...
        public TameCheckedExpressionSyntax(string code)
        {
            Node = SyntaxFactoryStr.ParseCheckedExpression(code);
            AddChildren();
        }

        public TameCheckedExpressionSyntax(CheckedExpressionSyntax node)
        {
            Node = node;
            AddChildren();
        }

        public TameCheckedExpressionSyntax()
        {
            KeywordStr = DefaultValues.CheckedExpressionSyntaxKeywordStr;
            OpenParenTokenStr = DefaultValues.CheckedExpressionSyntaxOpenParenTokenStr;
            ExpressionStr = DefaultValues.CheckedExpressionSyntaxExpressionStr;
            CloseParenTokenStr = DefaultValues.CheckedExpressionSyntaxCloseParenTokenStr;
        }
        ...
        public new void AddChildren()
        {
            base.AddChildren();
            Kind = Node.Kind();
            _keyword = ((CheckedExpressionSyntax) Node).Keyword;
            _keywordIsChanged = false;
            _openParenToken = ((CheckedExpressionSyntax) Node).OpenParenToken;
            _openParenTokenIsChanged = false;
            _expression = ((CheckedExpressionSyntax) Node).Expression;
            _expressionIsChanged = false;
            _closeParenToken = ((CheckedExpressionSyntax) Node).CloseParenToken;
            _closeParenTokenIsChanged = false;
        }
        ...
        public SyntaxKind GetKind()
        {
            ...
            return KeywordStr.ToLower() == "unchecked" ? SyntaxKind.UncheckedExpression : SyntaxKind.CheckedExpression;
        }

        public override SyntaxNode MakeSyntaxNode()
        {
            var res = SyntaxFactory.CheckedExpression(GetKind(), Keyword, OpenParenToken, Expression, CloseParenToken);
            IsChanged = false;
            return res;
        }
