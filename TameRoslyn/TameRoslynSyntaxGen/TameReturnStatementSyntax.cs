...
{
    public partial class TameReturnStatementSyntax : TameStatementSyntax
    {
        public new static string TypeName = "ReturnStatementSyntax";
        private ExpressionSyntax _expression;
        private bool _expressionIsChanged;
        private string _expressionStr;
        private SyntaxToken _returnKeyword;
        private bool _returnKeywordIsChanged;
        private string _returnKeywordStr;
        ...
        public TameReturnStatementSyntax(string code)
        {
            Node = SyntaxFactoryStr.ParseReturnStatement(code);
            AddChildren();
        }

        public TameReturnStatementSyntax(ReturnStatementSyntax node)
        {
            Node = node;
            AddChildren();
        }

        public TameReturnStatementSyntax()
        {
            ReturnKeywordStr = DefaultValues.ReturnStatementSyntaxReturnKeywordStr;
            ExpressionStr = DefaultValues.ReturnStatementSyntaxExpressionStr;
            SemicolonTokenStr = DefaultValues.ReturnStatementSyntaxSemicolonTokenStr;
        }
        ...
        public SyntaxToken ReturnKeyword
        {
            get
            {
                if (_returnKeywordIsChanged)
                {
                    if (_returnKeywordStr == null) _returnKeyword = default(SyntaxToken);
                    else
                        _returnKeyword = SyntaxFactoryStr.ParseSyntaxToken(_returnKeywordStr, SyntaxKind.ReturnKeyword);
                    _returnKeywordIsChanged = false;
                }
                return _returnKeyword;
            }
            set
            {
                if (_returnKeyword != value)
                {
                    _returnKeyword = value;
                    _returnKeywordIsChanged = false;
                    IsChanged = true;
                }
            }
        ...
        public string ReturnKeywordStr
        {
            get
            {
                if (_returnKeywordIsChanged) return _returnKeywordStr;
                return _returnKeywordStr = _returnKeyword.Text;
            }
            set
            {
                if (_returnKeywordStr != value)
                {
                    _returnKeywordStr = value;
                    IsChanged = true;
                    _returnKeywordIsChanged = true;
                }
            }
        }
        ...
        public new void AddChildren()
        {
            base.AddChildren();
            Kind = Node.Kind();
            _returnKeyword = ((ReturnStatementSyntax) Node).ReturnKeyword;
            _returnKeywordIsChanged = false;
            _expression = ((ReturnStatementSyntax) Node).Expression;
            _expressionIsChanged = false;
            _semicolonToken = ((ReturnStatementSyntax) Node).SemicolonToken;
            _semicolonTokenIsChanged = false;
        }
        ...
        {
            var res = SyntaxFactory.ReturnStatement(ReturnKeyword, Expression, SemicolonToken);
            IsChanged = false;
            return res;
        }
        ...
        {
            yield return ("ReturnKeywordStr", ReturnKeywordStr);
