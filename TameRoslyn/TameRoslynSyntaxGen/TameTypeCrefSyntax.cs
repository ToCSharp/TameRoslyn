...
{
    public partial class TameTypeCrefSyntax : TameCrefSyntax
    {
        public new static string TypeName = "TypeCrefSyntax";
        private TameTypeSyntax _taType;
        private TypeSyntax _type;
        private bool _typeIsChanged;
        private string _typeStr;

        public TameTypeCrefSyntax(string code)
        {
            Node = SyntaxFactoryStr.ParseTypeCref(code);
            AddChildren();
        }
        ...
        public TameTypeCrefSyntax()
        {
            // TypeStr = DefaultValues.TypeCrefSyntaxTypeStr;
        }
        ...
        public new void AddChildren()
        {
            base.AddChildren();
            Kind = Node.Kind();
            _type = ((TypeCrefSyntax) Node).Type;
            _typeIsChanged = false;
        }
        ...
        {
            var res = SyntaxFactory.TypeCref(Type);
            IsChanged = false;
            return res;
        }
