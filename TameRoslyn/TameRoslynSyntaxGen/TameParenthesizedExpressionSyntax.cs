...
{
    public partial class TameParenthesizedExpressionSyntax : TameExpressionSyntax
    {
        public new static string TypeName = "ParenthesizedExpressionSyntax";
        ...
        public TameParenthesizedExpressionSyntax(string code)
        {
            Node = SyntaxFactoryStr.ParseParenthesizedExpression(code);
            AddChildren();
        }

        public TameParenthesizedExpressionSyntax(ParenthesizedExpressionSyntax node)
        {
            Node = node;
            AddChildren();
        }

        public TameParenthesizedExpressionSyntax()
        {
            OpenParenTokenStr = DefaultValues.ParenthesizedExpressionSyntaxOpenParenTokenStr;
            ExpressionStr = DefaultValues.ParenthesizedExpressionSyntaxExpressionStr;
            CloseParenTokenStr = DefaultValues.ParenthesizedExpressionSyntaxCloseParenTokenStr;
        }
        ...
        public new void AddChildren()
        {
            base.AddChildren();
            Kind = Node.Kind();
            _openParenToken = ((ParenthesizedExpressionSyntax) Node).OpenParenToken;
            _openParenTokenIsChanged = false;
            _expression = ((ParenthesizedExpressionSyntax) Node).Expression;
            _expressionIsChanged = false;
            _closeParenToken = ((ParenthesizedExpressionSyntax) Node).CloseParenToken;
            _closeParenTokenIsChanged = false;
        }
        ...
        {
            var res = SyntaxFactory.ParenthesizedExpression(OpenParenToken, Expression, CloseParenToken);
            IsChanged = false;
            return res;
        }
