...
{
    public partial class TameThrowExpressionSyntax : TameExpressionSyntax
    {
        public new static string TypeName = "ThrowExpressionSyntax";
        private ExpressionSyntax _expression;
        private bool _expressionIsChanged;
        private string _expressionStr;
        private TameExpressionSyntax _taExpression;
        private SyntaxToken _throwKeyword;
        private bool _throwKeywordIsChanged;
        private string _throwKeywordStr;

        public TameThrowExpressionSyntax(string code)
        {
            Node = SyntaxFactoryStr.ParseThrowExpression(code);
            AddChildren();
        }

        public TameThrowExpressionSyntax(ThrowExpressionSyntax node)
        {
            Node = node;
            AddChildren();
        }

        public TameThrowExpressionSyntax()
        {
            ThrowKeywordStr = DefaultValues.ThrowExpressionSyntaxThrowKeywordStr;
            ExpressionStr = DefaultValues.ThrowExpressionSyntaxExpressionStr;
        }
        ...
        public SyntaxToken ThrowKeyword
        {
            get
            {
                if (_throwKeywordIsChanged)
                {
                    if (_throwKeywordStr == null) _throwKeyword = default(SyntaxToken);
                    else _throwKeyword = SyntaxFactoryStr.ParseSyntaxToken(_throwKeywordStr, SyntaxKind.ThrowKeyword);
                    _throwKeywordIsChanged = false;
                }
                return _throwKeyword;
            }
            set
            {
                if (_throwKeyword != value)
                {
                    _throwKeyword = value;
                    _throwKeywordIsChanged = false;
                    IsChanged = true;
        ...
        public string ThrowKeywordStr
        {
            get
            {
                if (_throwKeywordIsChanged) return _throwKeywordStr;
                return _throwKeywordStr = _throwKeyword.Text;
            }
            set
            {
                if (_throwKeywordStr != value)
                {
                    _throwKeywordStr = value;
                    IsChanged = true;
                    _throwKeywordIsChanged = true;
                }
            }
        }
        ...
        public new void AddChildren()
        {
            base.AddChildren();
            Kind = Node.Kind();
            _throwKeyword = ((ThrowExpressionSyntax) Node).ThrowKeyword;
            _throwKeywordIsChanged = false;
            _expression = ((ThrowExpressionSyntax) Node).Expression;
            _expressionIsChanged = false;
        }
        ...
        {
            var res = SyntaxFactory.ThrowExpression(ThrowKeyword, Expression);
            IsChanged = false;
            return res;
        }
        ...
        {
            yield return ("ThrowKeywordStr", ThrowKeywordStr);
