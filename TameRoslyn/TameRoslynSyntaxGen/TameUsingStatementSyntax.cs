...
{
    public partial class TameUsingStatementSyntax : TameStatementSyntax
    {
        public new static string TypeName = "UsingStatementSyntax";
        ...
        public TameUsingStatementSyntax(string code)
        {
            Node = SyntaxFactoryStr.ParseUsingStatement(code);
            AddChildren();
        }

        public TameUsingStatementSyntax(UsingStatementSyntax node)
        {
            Node = node;
            AddChildren();
        }

        public TameUsingStatementSyntax()
        {
            UsingKeywordStr = DefaultValues.UsingStatementSyntaxUsingKeywordStr;
            OpenParenTokenStr = DefaultValues.UsingStatementSyntaxOpenParenTokenStr;
            DeclarationStr = DefaultValues.UsingStatementSyntaxDeclarationStr;
            ExpressionStr = DefaultValues.UsingStatementSyntaxExpressionStr;
            CloseParenTokenStr = DefaultValues.UsingStatementSyntaxCloseParenTokenStr;
            StatementStr = DefaultValues.UsingStatementSyntaxStatementStr;
        }
        ...
        public new void AddChildren()
        {
            base.AddChildren();
            Kind = Node.Kind();
            _usingKeyword = ((UsingStatementSyntax) Node).UsingKeyword;
            _usingKeywordIsChanged = false;
            _openParenToken = ((UsingStatementSyntax) Node).OpenParenToken;
            _openParenTokenIsChanged = false;
            _declaration = ((UsingStatementSyntax) Node).Declaration;
            _declarationIsChanged = false;
            _expression = ((UsingStatementSyntax) Node).Expression;
            _expressionIsChanged = false;
            _closeParenToken = ((UsingStatementSyntax) Node).CloseParenToken;
            _closeParenTokenIsChanged = false;
            _statement = ((UsingStatementSyntax) Node).Statement;
            _statementIsChanged = false;
        }
        ...
        {
            var res = SyntaxFactory.UsingStatement(UsingKeyword, OpenParenToken, Declaration, Expression,
