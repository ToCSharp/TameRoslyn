...
{
    public partial class TameLetClauseSyntax : TameQueryClauseSyntax, IHaveIdentifier
    {
        public new static string TypeName = "LetClauseSyntax";
        ...
        private bool _letKeywordIsChanged;
        private string _letKeywordStr;
        private TameExpressionSyntax _taExpression;

        public TameLetClauseSyntax(string code)
        {
            Node = SyntaxFactoryStr.ParseLetClause(code);
            AddChildren();
        }
        ...
        public TameLetClauseSyntax()
        {
            LetKeywordStr = DefaultValues.LetClauseSyntaxLetKeywordStr;
            IdentifierStr = DefaultValues.LetClauseSyntaxIdentifierStr;
            EqualsTokenStr = DefaultValues.LetClauseSyntaxEqualsTokenStr;
            ExpressionStr = DefaultValues.LetClauseSyntaxExpressionStr;
        }
        ...
        public SyntaxToken LetKeyword
        {
            get
            {
                if (_letKeywordIsChanged)
                {
                    if (_letKeywordStr == null) _letKeyword = default(SyntaxToken);
                    else _letKeyword = SyntaxFactoryStr.ParseSyntaxToken(_letKeywordStr, SyntaxKind.LetKeyword);
                    _letKeywordIsChanged = false;
                }
                return _letKeyword;
            }
            set
            {
                if (_letKeyword != value)
                {
                    _letKeyword = value;
                    _letKeywordIsChanged = false;
                    IsChanged = true;
        ...
        public string LetKeywordStr
        {
            get
            {
                if (_letKeywordIsChanged) return _letKeywordStr;
                return _letKeywordStr = _letKeyword.Text;
            }
            set
            {
                if (_letKeywordStr != value)
                {
                    _letKeywordStr = value;
                    IsChanged = true;
                    _letKeywordIsChanged = true;
                }
            }
        }
        ...
        public new void AddChildren()
        {
            base.AddChildren();
            Kind = Node.Kind();
            _letKeyword = ((LetClauseSyntax) Node).LetKeyword;
            _letKeywordIsChanged = false;
            _identifier = ((LetClauseSyntax) Node).Identifier;
            _identifierIsChanged = false;
            _equalsToken = ((LetClauseSyntax) Node).EqualsToken;
            _equalsTokenIsChanged = false;
            _expression = ((LetClauseSyntax) Node).Expression;
            _expressionIsChanged = false;
        }
        ...
        {
            var res = SyntaxFactory.LetClause(LetKeyword, Identifier, EqualsToken, Expression);
            IsChanged = false;
            return res;
        }
        ...
        {
            yield return ("LetKeywordStr", LetKeywordStr);
