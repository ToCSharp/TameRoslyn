...
{
    public partial class TameDeclarationExpressionSyntax : TameExpressionSyntax
    {
        public new static string TypeName = "DeclarationExpressionSyntax";
        ...
        public TameDeclarationExpressionSyntax(string code)
        {
            Node = SyntaxFactoryStr.ParseDeclarationExpression(code);
            AddChildren();
        }

        public TameDeclarationExpressionSyntax(DeclarationExpressionSyntax node)
        {
            Node = node;
            AddChildren();
        }

        public TameDeclarationExpressionSyntax()
        {
            TypeStr = DefaultValues.DeclarationExpressionSyntaxTypeStr;
            DesignationStr = DefaultValues.DeclarationExpressionSyntaxDesignationStr;
        }
        ...
        {
            var res = SyntaxFactory.DeclarationExpression(Type, Designation);
            IsChanged = false;
            return res;
        }
