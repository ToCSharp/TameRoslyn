...
{
    public partial class TameRefTypeExpressionSyntax : TameExpressionSyntax
    {
        public new static string TypeName = "RefTypeExpressionSyntax";
        ...
        public TameRefTypeExpressionSyntax(string code)
        {
            Node = SyntaxFactoryStr.ParseRefTypeExpression(code);
            AddChildren();
        }
        ...
        public TameRefTypeExpressionSyntax()
        {
            // KeywordStr = DefaultValues.RefTypeExpressionSyntaxKeywordStr;
            // OpenParenTokenStr = DefaultValues.RefTypeExpressionSyntaxOpenParenTokenStr;
            // ExpressionStr = DefaultValues.RefTypeExpressionSyntaxExpressionStr;
            // CloseParenTokenStr = DefaultValues.RefTypeExpressionSyntaxCloseParenTokenStr;
        }
        ...
        public new void AddChildren()
        {
            base.AddChildren();
            Kind = Node.Kind();
            _keyword = ((RefTypeExpressionSyntax) Node).Keyword;
            _keywordIsChanged = false;
            _openParenToken = ((RefTypeExpressionSyntax) Node).OpenParenToken;
            _openParenTokenIsChanged = false;
            _expression = ((RefTypeExpressionSyntax) Node).Expression;
            _expressionIsChanged = false;
            _closeParenToken = ((RefTypeExpressionSyntax) Node).CloseParenToken;
            _closeParenTokenIsChanged = false;
        }
        ...
        {
            var res = SyntaxFactory.RefTypeExpression(Keyword, OpenParenToken, Expression, CloseParenToken);
            IsChanged = false;
            return res;
        }
