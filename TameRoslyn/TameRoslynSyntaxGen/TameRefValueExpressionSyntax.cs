...
{
    public partial class TameRefValueExpressionSyntax : TameExpressionSyntax
    {
        public new static string TypeName = "RefValueExpressionSyntax";
        ...
        private bool _commaIsChanged;
        private string _commaStr;
        ...
        public TameRefValueExpressionSyntax(string code)
        {
            Node = SyntaxFactoryStr.ParseRefValueExpression(code);
            AddChildren();
        }
        ...
        public TameRefValueExpressionSyntax()
        {
            // KeywordStr = DefaultValues.RefValueExpressionSyntaxKeywordStr;
            // OpenParenTokenStr = DefaultValues.RefValueExpressionSyntaxOpenParenTokenStr;
            // ExpressionStr = DefaultValues.RefValueExpressionSyntaxExpressionStr;
            // CommaStr = DefaultValues.RefValueExpressionSyntaxCommaStr;
            // TypeStr = DefaultValues.RefValueExpressionSyntaxTypeStr;
            // CloseParenTokenStr = DefaultValues.RefValueExpressionSyntaxCloseParenTokenStr;
        }
        ...
        public SyntaxToken Comma
        {
            get
            {
                if (_commaIsChanged)
                {
                    _comma = SyntaxFactoryStr.ParseSyntaxToken(CommaStr);
                    _commaIsChanged = false;
                }
                return _comma;
            }
            set
        ...
        public string CommaStr
        {
            get
            {
                if (_commaIsChanged) return _commaStr;
                return _commaStr = _comma.Text;
            }
            set
            {
                if (_commaStr != value)
        ...
        public new void AddChildren()
        {
            base.AddChildren();
            Kind = Node.Kind();
            _keyword = ((RefValueExpressionSyntax) Node).Keyword;
            _keywordIsChanged = false;
            _openParenToken = ((RefValueExpressionSyntax) Node).OpenParenToken;
            _openParenTokenIsChanged = false;
            _expression = ((RefValueExpressionSyntax) Node).Expression;
            _expressionIsChanged = false;
            _comma = ((RefValueExpressionSyntax) Node).Comma;
            _commaIsChanged = false;
            _type = ((RefValueExpressionSyntax) Node).Type;
            _typeIsChanged = false;
            _closeParenToken = ((RefValueExpressionSyntax) Node).CloseParenToken;
            _closeParenTokenIsChanged = false;
        }
        ...
        {
            var res = SyntaxFactory.RefValueExpression(Keyword, OpenParenToken, Expression, Comma, Type,
                CloseParenToken);
            IsChanged = false;
            return res;
        }
        ...
        public override IEnumerable<(string filedName, string value)> GetStringFields()
        {
            ...
            yield return ("CommaStr", CommaStr);
