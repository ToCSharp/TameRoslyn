...
{
    public partial class TameSizeOfExpressionSyntax : TameExpressionSyntax
    {
        public new static string TypeName = "SizeOfExpressionSyntax";
        ...
        public TameSizeOfExpressionSyntax(string code)
        {
            Node = SyntaxFactoryStr.ParseSizeOfExpression(code);
            AddChildren();
        }
        ...
        public TameSizeOfExpressionSyntax()
        {
            KeywordStr = DefaultValues.SizeOfExpressionSyntaxKeywordStr;
            OpenParenTokenStr = DefaultValues.SizeOfExpressionSyntaxOpenParenTokenStr;
            TypeStr = DefaultValues.SizeOfExpressionSyntaxTypeStr;
            CloseParenTokenStr = DefaultValues.SizeOfExpressionSyntaxCloseParenTokenStr;
        }
        ...
        public new void AddChildren()
        {
            base.AddChildren();
            Kind = Node.Kind();
            _keyword = ((SizeOfExpressionSyntax) Node).Keyword;
            _keywordIsChanged = false;
            _openParenToken = ((SizeOfExpressionSyntax) Node).OpenParenToken;
            _openParenTokenIsChanged = false;
            _type = ((SizeOfExpressionSyntax) Node).Type;
            _typeIsChanged = false;
            _closeParenToken = ((SizeOfExpressionSyntax) Node).CloseParenToken;
            _closeParenTokenIsChanged = false;
        }
        ...
        {
            var res = SyntaxFactory.SizeOfExpression(Keyword, OpenParenToken, Type, CloseParenToken);
            IsChanged = false;
            return res;
        }
