...
{
    public partial class TameInvocationExpressionSyntax : TameExpressionSyntax
    {
        public new static string TypeName = "InvocationExpressionSyntax";
        ...
        public TameInvocationExpressionSyntax(string code)
        {
            Node = SyntaxFactoryStr.ParseInvocationExpression(code);
            AddChildren();
        }

        public TameInvocationExpressionSyntax(InvocationExpressionSyntax node)
        {
            Node = node;
            AddChildren();
        }

        public TameInvocationExpressionSyntax()
        {
            ExpressionStr = DefaultValues.InvocationExpressionSyntaxExpressionStr;
            ArgumentListStr = DefaultValues.InvocationExpressionSyntaxArgumentListStr;
        }
        ...
        public new void AddChildren()
        {
            base.AddChildren();
            Kind = Node.Kind();
            _expression = ((InvocationExpressionSyntax) Node).Expression;
            _expressionIsChanged = false;
            _argumentList = ((InvocationExpressionSyntax) Node).ArgumentList;
            _argumentListIsChanged = false;
        }
        ...
        {
            var res = SyntaxFactory.InvocationExpression(Expression, ArgumentList);
            IsChanged = false;
            return res;
        }
