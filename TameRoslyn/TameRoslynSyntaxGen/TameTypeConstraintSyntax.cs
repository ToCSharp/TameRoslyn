...
{
    public partial class TameTypeConstraintSyntax : TameTypeParameterConstraintSyntax
    {
        public new static string TypeName = "TypeConstraintSyntax";
        private TameTypeSyntax _taType;
        private TypeSyntax _type;
        private bool _typeIsChanged;
        private string _typeStr;

        public TameTypeConstraintSyntax(string code)
        {
            Node = SyntaxFactoryStr.ParseTypeConstraint(code);
            AddChildren();
        }
        ...
        public TameTypeConstraintSyntax()
        {
            TypeStr = DefaultValues.TypeConstraintSyntaxTypeStr;
        }
        ...
        public new void AddChildren()
        {
            base.AddChildren();
            Kind = Node.Kind();
            _type = ((TypeConstraintSyntax) Node).Type;
            _typeIsChanged = false;
        }
        ...
        {
            var res = SyntaxFactory.TypeConstraint(Type);
            IsChanged = false;
            return res;
        }
