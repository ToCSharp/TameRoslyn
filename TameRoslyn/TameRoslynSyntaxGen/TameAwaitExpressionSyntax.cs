...
{
    public partial class TameAwaitExpressionSyntax : TameExpressionSyntax
    {
        public new static string TypeName = "AwaitExpressionSyntax";
        private SyntaxToken _awaitKeyword;
        private bool _awaitKeywordIsChanged;
        private string _awaitKeywordStr;
        private ExpressionSyntax _expression;
        private bool _expressionIsChanged;
        private string _expressionStr;
        private TameExpressionSyntax _taExpression;

        public TameAwaitExpressionSyntax(string code)
        {
            Node = SyntaxFactoryStr.ParseAwaitExpression(code);
            AddChildren();
        }

        public TameAwaitExpressionSyntax(AwaitExpressionSyntax node)
        {
            Node = node;
            AddChildren();
        }

        public TameAwaitExpressionSyntax()
        {
            AwaitKeywordStr = DefaultValues.AwaitExpressionSyntaxAwaitKeywordStr;
            ExpressionStr = DefaultValues.AwaitExpressionSyntaxExpressionStr;
        }
        ...
        public SyntaxToken AwaitKeyword
        {
            get
            {
                if (_awaitKeywordIsChanged)
                {
                    if (_awaitKeywordStr == null) _awaitKeyword = default(SyntaxToken);
                    else _awaitKeyword = SyntaxFactoryStr.ParseSyntaxToken(_awaitKeywordStr, SyntaxKind.AwaitKeyword);
                    _awaitKeywordIsChanged = false;
                }
                return _awaitKeyword;
            }
            set
            {
                if (_awaitKeyword != value)
                {
                    _awaitKeyword = value;
                    _awaitKeywordIsChanged = false;
                    IsChanged = true;
        ...
        public string AwaitKeywordStr
        {
            get
            {
                if (_awaitKeywordIsChanged) return _awaitKeywordStr;
                return _awaitKeywordStr = _awaitKeyword.Text;
            }
            set
            {
                if (_awaitKeywordStr != value)
                {
                    _awaitKeywordStr = value;
                    IsChanged = true;
                    _awaitKeywordIsChanged = true;
                }
            }
        }
        ...
        public new void AddChildren()
        {
            base.AddChildren();
            Kind = Node.Kind();
            _awaitKeyword = ((AwaitExpressionSyntax) Node).AwaitKeyword;
            _awaitKeywordIsChanged = false;
            _expression = ((AwaitExpressionSyntax) Node).Expression;
            _expressionIsChanged = false;
        }
        ...
        {
            yield return ("AwaitKeywordStr", AwaitKeywordStr);
