...
{
    public partial class TameRefExpressionSyntax : TameExpressionSyntax
    {
        public new static string TypeName = "RefExpressionSyntax";
        ...
        public TameRefExpressionSyntax(string code)
        {
            Node = SyntaxFactoryStr.ParseRefExpression(code);
            AddChildren();
        }
        ...
        public TameRefExpressionSyntax()
        {
            // RefKeywordStr = DefaultValues.RefExpressionSyntaxRefKeywordStr;
            // ExpressionStr = DefaultValues.RefExpressionSyntaxExpressionStr;
        }
        ...
        public new void AddChildren()
        {
            base.AddChildren();
            Kind = Node.Kind();
            _refKeyword = ((RefExpressionSyntax) Node).RefKeyword;
            _refKeywordIsChanged = false;
            _expression = ((RefExpressionSyntax) Node).Expression;
            _expressionIsChanged = false;
        }
        ...
        {
            var res = SyntaxFactory.RefExpression(RefKeyword, Expression);
            IsChanged = false;
            return res;
        }
