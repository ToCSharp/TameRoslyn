...
{
    public partial class TameAssignmentExpressionSyntax : TameExpressionSyntax
    {
        public new static string TypeName = "AssignmentExpressionSyntax";
        ...
        public TameAssignmentExpressionSyntax(string code)
        {
            Node = SyntaxFactoryStr.ParseAssignmentExpression(code);
            AddChildren();
        }

        public TameAssignmentExpressionSyntax(AssignmentExpressionSyntax node)
        {
            Node = node;
            AddChildren();
        }

        public TameAssignmentExpressionSyntax()
        {
            LeftStr = DefaultValues.AssignmentExpressionSyntaxLeftStr;
            OperatorTokenStr = DefaultValues.AssignmentExpressionSyntaxOperatorTokenStr;
            RightStr = DefaultValues.AssignmentExpressionSyntaxRightStr;
        }
        ...
        public new void AddChildren()
        {
            base.AddChildren();
            Kind = Node.Kind();
            _left = ((AssignmentExpressionSyntax) Node).Left;
            _leftIsChanged = false;
            _operatorToken = ((AssignmentExpressionSyntax) Node).OperatorToken;
            _operatorTokenIsChanged = false;
            _right = ((AssignmentExpressionSyntax) Node).Right;
            _rightIsChanged = false;
        }
        ...
        public SyntaxKind GetKind()
        {
            ...
            return SyntaxFacts.GetAssignmentExpression(TameSyntaxFacts.SyntaxKindFromStr(OperatorTokenStr));
        }

        public override SyntaxNode MakeSyntaxNode()
        {
            var res = SyntaxFactory.AssignmentExpression(GetKind(), Left, OperatorToken, Right);
            IsChanged = false;
            return res;
        }
