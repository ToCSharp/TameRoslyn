...
{
    public partial class TamePostfixUnaryExpressionSyntax : TameExpressionSyntax
    {
        public new static string TypeName = "PostfixUnaryExpressionSyntax";
        ...
        public TamePostfixUnaryExpressionSyntax(string code)
        {
            Node = SyntaxFactoryStr.ParsePostfixUnaryExpression(code);
            AddChildren();
        }

        public TamePostfixUnaryExpressionSyntax(PostfixUnaryExpressionSyntax node)
        {
            Node = node;
            AddChildren();
        }

        public TamePostfixUnaryExpressionSyntax()
        {
            OperandStr = DefaultValues.PostfixUnaryExpressionSyntaxOperandStr;
            OperatorTokenStr = DefaultValues.PostfixUnaryExpressionSyntaxOperatorTokenStr;
        }
        ...
        public new void AddChildren()
        {
            base.AddChildren();
            Kind = Node.Kind();
            _operand = ((PostfixUnaryExpressionSyntax) Node).Operand;
            _operandIsChanged = false;
            _operatorToken = ((PostfixUnaryExpressionSyntax) Node).OperatorToken;
            _operatorTokenIsChanged = false;
        }
        ...
        {
            var res = SyntaxFactory.PostfixUnaryExpression(GetKind(), Operand, OperatorToken);
            IsChanged = false;
            return res;
        }
