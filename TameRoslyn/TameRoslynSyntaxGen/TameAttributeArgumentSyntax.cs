...
{
    public partial class TameAttributeArgumentSyntax : TameBaseRoslynNode
    {
        public static string TypeName = "AttributeArgumentSyntax";
        private ExpressionSyntax _expression;
        private bool _expressionIsChanged;
        private string _expressionStr;
        private NameColonSyntax _nameColon;
        private bool _nameColonIsChanged;
        private string _nameColonStr;
        ...
        private TameNameColonSyntax _taNameColon;
        private TameNameEqualsSyntax _taNameEquals;

        public TameAttributeArgumentSyntax(string code)
        {
            Node = SyntaxFactoryStr.ParseAttributeArgument(code);
            AddChildren();
        }

        public TameAttributeArgumentSyntax(AttributeArgumentSyntax node)
        {
            Node = node;
            AddChildren();
        }

        public TameAttributeArgumentSyntax()
        {
            NameEqualsStr = DefaultValues.AttributeArgumentSyntaxNameEqualsStr;
            NameColonStr = DefaultValues.AttributeArgumentSyntaxNameColonStr;
            ExpressionStr = DefaultValues.AttributeArgumentSyntaxExpressionStr;
        }
        ...
        public NameColonSyntax NameColon
        {
            get
            {
                if (_nameColonIsChanged)
                {
                    _nameColon = SyntaxFactoryStr.ParseNameColonSyntax(NameColonStr);
                    _nameColonIsChanged = false;
                    _taNameColon = null;
                }
                else if (_taNameColon != null && _taNameColon.IsChanged)
                {
                    _nameColon = (NameColonSyntax) _taNameColon.Node;
                }
                return _nameColon;
            }
            set
        ...
        public string NameColonStr
        {
            get
            {
                if (_taNameColon != null && _taNameColon.IsChanged)
                    NameColon = (NameColonSyntax) _taNameColon.Node;
                if (_nameColonIsChanged) return _nameColonStr;
                return _nameColonStr = _nameColon?.ToFullString();
            }
            set
            {
                if (_taNameColon != null && _taNameColon.IsChanged)
                {
                    NameColon = (NameColonSyntax) _taNameColon.Node;
                    _nameColonStr = _nameColon?.ToFullString();
                }
                if (_nameColonStr != value)
                {
                    _nameColonStr = value;
                    IsChanged = true;
                    _nameColonIsChanged = true;
                    _taNameColon = null;
                }
            }
        }

        public TameNameColonSyntax TaNameColon
        {
            get
            {
                if (_taNameColon == null && NameColon != null)
                {
                    _taNameColon = new TameNameColonSyntax(NameColon) {TaParent = this};
                    _taNameColon.AddChildren();
                }
                return _taNameColon;
            }
            set
            {
                if (_taNameColon != value)
                {
                    _taNameColon = value;
                    if (_taNameColon != null)
                    {
                        _taNameColon.TaParent = this;
                        _taNameColon.IsChanged = true;
                    }
                    else
                    {
                        IsChanged = true;
        ...
        public override IEnumerable<TameBaseRoslynNode> GetTameFields()
        {
            ...
            if (TaNameColon != null) yield return TaNameColon;
        ...
        public override IEnumerable<(string filedName, string value)> GetStringFields()
        {
            ...
            yield return ("NameColonStr", NameColonStr);
