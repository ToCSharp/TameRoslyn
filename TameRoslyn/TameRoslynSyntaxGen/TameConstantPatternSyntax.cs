...
{
    public partial class TameConstantPatternSyntax : TamePatternSyntax
    {
        public new static string TypeName = "ConstantPatternSyntax";
        private ExpressionSyntax _expression;
        private bool _expressionIsChanged;
        private string _expressionStr;
        private TameExpressionSyntax _taExpression;

        public TameConstantPatternSyntax(string code)
        {
            Node = SyntaxFactoryStr.ParseConstantPattern(code);
            AddChildren();
        }
        ...
        public TameConstantPatternSyntax()
        {
            ExpressionStr = DefaultValues.ConstantPatternSyntaxExpressionStr;
        }
        ...
        public new void AddChildren()
        {
            base.AddChildren();
            Kind = Node.Kind();
            _expression = ((ConstantPatternSyntax) Node).Expression;
            _expressionIsChanged = false;
        }
        ...
        {
            var res = SyntaxFactory.ConstantPattern(Expression);
            IsChanged = false;
            return res;
        }
